...
while(True):
    ...
    gaphalf = 51
    distanceLeft = ard.dmm(0)
    distanceRight = ard.dmm(1)
    print("Sensor Left: ", distanceLeft)
    #print("Sensor 1: ", s1calib)
    time.sleep(1)
    print("Sensor Right: ", distanceRight)
    #print("Sensor 2: ", s2calib)
    print("Gap 1: " , (distanceLeft*0.64))
    print("Gap 2: " , (distanceRight*0.48))
    time.sleep(1)
    leftGap = 51.5-(distanceLeft-32)
    time.sleep(1)
    rightGap = 51.5-(distanceRight-24)
    print("Left:", leftGap)
